...
python /sfo/py_job/gate_allocation/Python_gate_allocation/main_smallest.py >> /sfo/py_job/gate_allocation/Python_gate_allocation/output/$start_date-results.log
